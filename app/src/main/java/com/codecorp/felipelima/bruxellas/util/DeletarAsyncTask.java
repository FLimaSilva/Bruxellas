...
public class DeletarAsyncTask extends AsyncTask<String, String, String>{
    ...
    public DeletarAsyncTask(Pedidos pedidos, Context context){
    ...
    protected void onPreExecute(){
        Log.i("WebService", "DeletarAsyncTask()");
    }
    ...
    protected String doInBackground(String... strings) {//faz de fato a sincronização com o webservice
        ...
        try {
            url = new URL(UtilRestaurante.URL_WEB_SERVICE+"APIDeletarDados_pedido.php");

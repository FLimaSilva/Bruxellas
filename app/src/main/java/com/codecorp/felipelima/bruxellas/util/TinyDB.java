...
public class TinyDB {
    ...
    public JsonArray getListEstoque(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        JsonArray itensEstoque =  new JsonArray();

        for(String jObjString : objStrings){
            JsonElement item  = gson.fromJson(jObjString,  JsonElement.class);
            itensEstoque.add(item);
        }
        return itensEstoque;
    }

    public ArrayList<Pratos> getListPratos(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Pratos> pratosArrayList =  new ArrayList<Pratos>();

        for(String jObjString : objStrings){
            Pratos pratos  = gson.fromJson(jObjString,  Pratos.class);
            pratosArrayList.add(pratos);
        }
        return pratosArrayList;
    }

    public ArrayList<Bebidas> getListBebidas(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Bebidas> bebidasArrayList =  new ArrayList<Bebidas>();

        for(String jObjString : objStrings){
            Bebidas bebidas  = gson.fromJson(jObjString,  Bebidas.class);
            bebidasArrayList.add(bebidas);
        }
        return bebidasArrayList;
    }

    public ArrayList<AdicionalRetirada> getListAdRe(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<AdicionalRetirada> adicionalRetiradaArrayList =  new ArrayList<AdicionalRetirada>();

        for(String jObjString : objStrings){
            AdicionalRetirada adicionalRetirada  = gson.fromJson(jObjString,  AdicionalRetirada.class);
            adicionalRetiradaArrayList.add(adicionalRetirada);
        }
        return adicionalRetiradaArrayList;
    }

    public ArrayList<AdicionalRetiradaPedido> getListAdRePedido(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<AdicionalRetiradaPedido> adicionalRetiradaPedidoArrayList =  new ArrayList<AdicionalRetiradaPedido>();

        for(String jObjString : objStrings){
            AdicionalRetiradaPedido adicionalRetiradaPedido  = gson.fromJson(jObjString,  AdicionalRetiradaPedido.class);
            adicionalRetiradaPedidoArrayList.add(adicionalRetiradaPedido);
        }
        return adicionalRetiradaPedidoArrayList;
    }
    ...
    public void putListEstoque(String key, JsonArray itensEstoque){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(JsonElement item : itensEstoque){
            objStrings.add(gson.toJson(item));
        }
        putListString(key, objStrings);
    }

    public void putListPratos(String key, ArrayList<Pratos> pratosArrayList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Pratos pratos : pratosArrayList){
            objStrings.add(gson.toJson(pratos));
        }
        putListString(key, objStrings);
    }

    public void putListBebidas(String key, ArrayList<Bebidas> bebidasArrayList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Bebidas bebidas : bebidasArrayList){
            objStrings.add(gson.toJson(bebidas));
        }
        putListString(key, objStrings);
    }

    public void putListAdRe(String key, ArrayList<AdicionalRetirada> adicionalRetiradaArrayList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(AdicionalRetirada adicionalRetirada : adicionalRetiradaArrayList){
            objStrings.add(gson.toJson(adicionalRetirada));
        }
        putListString(key, objStrings);
    }

    public void putListAdRePedido(String key, ArrayList<AdicionalRetiradaPedido> adicionalRetiradaPedidoArrayList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(AdicionalRetiradaPedido adicionalRetiradaPedido : adicionalRetiradaPedidoArrayList){
            objStrings.add(gson.toJson(adicionalRetiradaPedido));
        }
        putListString(key, objStrings);
    }
